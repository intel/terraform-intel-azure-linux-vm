...
This example creates an Azure Virtual Machine on Intel® 5th Generation Xeon® Scalable Emerald Rapids CPUs on Linux Operating System using Custom image from Intel Marketplace gallery . The virtual machine is created on Standard_D2s_v6 by default.
